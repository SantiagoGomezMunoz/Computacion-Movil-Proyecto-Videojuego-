...
public class FinalHistoria : MonoBehaviour
{
    ...
    [TextArea(4, 10)]
    public string[] parrafos = {"El jugador encontró una radio en el suelo, algo rota pero funcional al lado de un carro policial donde a pesar de las bajas frecuencias aún se podía escuchar a un agente solicitando refuerzos para contrarrestar los ataques de los androides en un refugio de supervivientes.",
